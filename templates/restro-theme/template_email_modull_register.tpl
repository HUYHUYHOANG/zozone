                    ...
                    <div class="row no-mar block-bot-space">
                        <div class="container clearfix dc">
                            ...
                            <div style="text-align: center;margin-top:20px;" class="title">
                                <h1 style="color: black;font-weight: 500;margin: 0;padding:0;letter-spacing:1px;line-height: 20px;font-size: 14px;" class="title-top-space">{RESTAURANT_NAME} hat folgende Modull bestellt</h1>
