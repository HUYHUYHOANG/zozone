...
function readImageURLandSave(input, id) {

var $btn = $('#' + id).closest('.uploadButton').find('.uploadButton-button');                 
var $action = '?action=CommonSaveImage&id=' + id; 
var formData = new FormData();
 formData.append('image', $('#' + id).closest('.readImageURLParent').find('.uploadButton-input')[0].files[0]);  
