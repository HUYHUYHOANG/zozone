(function ($) {
    var $qr_wrapper = $('#qr-code-wrapper'),
        ...
        $qr_content_type = $('#qr_content_type').val();
        $qr_content_text = $('#qr_content_text').val();
        $content_text = $qr_wrapper.data('url');
        if($qr_content_type == "TEXT")
        {
            $content_text = $qr_content_text;
        }


       // var $qr_table = $('#qr-table');
      //  var $qr_table_text = '';
    ...
    $('input, select').on('input change', function () {
        // if($qr_table.val() != '')
        // {
        //     $qr_table_text =  " " + LANG_TABLE  + " " + $qr_table.val();
        // }
        // else
        // {
        //     $qr_table_text = "";
