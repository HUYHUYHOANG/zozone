$(document).on('click', ".add-cat", function (e) {
    ...
    $('#cat-edit-id').val('');
    $('#category_name').val('');
    $('#title_popup_category').html(LANG_ADD_CATEGORY);
...
$(document).on('click', ".edit-cat", function (e) {
    ...
    $('#title_popup_category').html(LANG_EDIT_CATEGORY);
    $("#category-status").hide();
    $.magnificPopup.open({
        items: {
            src: '#add-category',
...
$(document).on('click', ".add_sub_cat_item", function (e) {
    ...
    $('#title_popup_sub_category').html(LANG_ADD_SUB_CATEGORY);
    $('#category-status').hide();
...
$(document).on('click', ".edit-sub-cat", function (e) {
    ...
    $('#title_popup_sub_category').html(LANG_EDIT_SUB_CATEGORY);
    $('#category-status').hide();
...
$(document).on('click', ".copy_menu_item", function(e){
    ...
    e.stopPropagation();
    var id = $(this).data('id');
   location.href = 'crush-menu?menu_id=' + id + '&type=copy';
})
$(document).on('click', ".edit_menu_item", function (e) {
    e.preventDefault();
    e.stopPropagation();
    var id = $(this).data('id');
location.href = 'crush-menu?menu_id=' + id;
    // $('#image_upload').val('');
...
$(document).on('click', ".add_menu_item", function (e) {
    ...
    location.href = 'crush-menu?cat_id=' + car_id;
    // $('#image_upload').val('');
    // $.ajax({
    //     type: "POST",
...
$("#add-item-form").on('submit', function (e) {
    ...
    {
        $("#add-item-status").removeClass('success').addClass('error').html('<p>' + LANG_PLEASE_ENTER_ITEM_ID + '</p>').slideDown();
        return false;
    }
