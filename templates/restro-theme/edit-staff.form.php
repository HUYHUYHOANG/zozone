    ...
    <div class="row"><!--row 1-->
        ...
        <div class="col-xl-6 col-md-12">
            <div class="submit-field">
                ...
                <select class="selectpicker" id="svc_gids" multiple data-max-options="5">
                    <?php
        ...
        <div class="col-xl-6 col-md-12">
            ...
            <h5><?php echo $lang['PHONE']?></h5>
                <div class="input-with-icon-left">
                    ...
                    <input type="text" class="with-border" id="phone" name="phone" maxlength="20" value="<?php echo $data ? $data->phone : ''?>"/>
                </div>
            </div>
        </div>
        <div class="col-xl-6 col-md-12">
