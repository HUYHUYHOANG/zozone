        ...
        <div class="col-xl-5 offset-xl-3">
            <div class="login-register-page">
                ...
                <form method="post" id="register-account-form" action="#" accept-charset="UTF-8">
                    ...
                    <div class="form-group">
                        <div id="reg-msg" class="loading">{LANG_PLEASE_WAIT_FOR_CONFIRMATION}...</div>
                    </div>
...
<script>
    ...
    $(function(){
        $('#register-account-form').submit(function(){            
            $('#register-account-form').find('input,button').addClass('disabled').prop('disabled',1);
            $('#reg-msg').slideDown();            
        });
    });
</script>
<style>    
    ...
    .loading{
        ...
        background-image:url({SITE_URL}templates/{TPL_NAME}/images/loading.svg.php?clr=I0EwQTBBMA==) !important;
        padding:15px 42px;
        font-weight: 600;
        display: none;
    }
