{OVERALL_HEADER}
<section id="main" class="clearfix text-center margin-top-20 margin-bottom-20">
    <div class="container">
        <div class="row">
                <div class="found-section section">
                    <div class="container container_agb margin-top-20">
                        <div class="row" id="quickad-tbs">
                            <div id="quickad-sidebar"  class="col-sm-3">
                                <ul class="quickad-nav"  role="tablist">
                                    <li class="quickad-nav-item "><a href="{SITE_URL}">Startseite</a></li>
                                    <li class="quickad-nav-item "><a href="{LINK_AGB_KUNDEN}">AGB</a></li>
                                    <li class="quickad-nav-item active"><a href="#">Datenschutzerklärung</a>
                                    </li>
                                    <li class="quickad-nav-item"><a href="{LINK_IMPRESSUM_KUNDEN}">IMPRESSUM</a></li>                              
                                </ul>
                            </div>
                            <div class="col-sm-9">
...
<p>{FAX}</p>
<p>{EMAIL}</p>
<p>Weitere Angaben zu unserem Unternehmen entnehmen Sie bitte den  Impressumsangaben auf unserer Internetseite <a href="{LINK_IMPRESSUM_KUNDEN}">Impressum</a>.</p>
...
<p>- Art. 6 Abs. 1 S. 1 lit. c DSGVO: Wenn die Verarbeitung zur Erfüllung einer rechtlichen Verpflichtung erforderlich ist, der der Verantwortliche unterliegt (z. B. eine gesetzliche Aufbewahrungspflicht);</p>
...
<p>–	Sharing Cookies: Diese dienen dazu, die Interaktivität unserer Webseite mit anderen Diensten (z. B. sozialen Netzwerken) zu verbessern; Sharing Cookies werden maximal 13 Monate lang gespeichert.</p>
