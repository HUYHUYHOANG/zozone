    ...
    <div class="dashboard-content-container" data-simplebar>
        <div class="dashboard-content-inner" >
            ...
            <div class="dashboard-headline">
                <h3>{LANG_ADD} {LANG_STAFF}</h3>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs" class="dark">
                    <ul>
                        <li><a href="{LINK_INDEX}">{LANG_HOME}</a></li>
                        <li>{LANG_ADD} {LANG_STAFF}</li>
                    </ul>
                </nav>
            </div>
                        ...
                        <div class="col-xl-12 col-sm-12">
                            <div class="row headline">
                                <div class="col-xl-6 col-sm-6">
                                    <h3><i class="la la-user"></i> {LANG_STAFF}</h3>
                                </div>
                                <div class="col-xl-6 col-sm-6">
...
<script type="text/javascript">
    ...
    $.initStaffControls = function(){        
        ...
        $('.pwd').pwdInput(function(_this, ret){
    ...
    $.staffformSubmit = function(_form){        
        ...
        /*encode the pwd */
        if(1||boConfigParams.secretChanged){            
