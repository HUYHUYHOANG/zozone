                        ...
                        <div class="container clearfix dc">
                            <div style="width:100%;height:100px;" class="email-header">
                                <div style="text-align: center;" id="email-logo">      
                                    ...
                                    src="{SITE_URL}storage/logo/{SITE_LOGO}" alt="{SITE_TITLE}">
                                </div>   
                            </div>
                            <div style="text-align: left;margin-top:20px;" class="title">
                             {CONTENT_EMAIL}
                            </div> 
                            <div  style="height: 1px;width:100%;border-top:dotted 2px;margin-top:20px"></div>

                            <div class="customer_info">
                                <h2  style="font-weight: bold;margin: 0;padding: 0;font-size: 12px;">{SITE_NAME}</h2>
                                <h3 style="font-weight: 500;margin: 0;padding: 0;font-size: 12px;">{SITE_ADDRESS}</h3>
                                <h3 style="font-weight: 500;margin: 0;padding: 0;font-size: 12px;">{SITE_TELEPHONE}</h3>
                            </div>
                        </div>
                    </div>
                </div>
