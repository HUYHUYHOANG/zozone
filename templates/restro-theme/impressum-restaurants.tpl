                    ...
                    <div class="row" id="quickad-tbs">
                        <div id="quickad-sidebar" class="col-sm-3">
                            <ul class="quickad-nav" role="tablist">
                                <li class="quickad-nav-item "><a href="{SITE_URL}{SLUG}">Startseite</a></li>
                                <li class="quickad-nav-item "><a href="{LINK_AGB_RESTAURANTS}?id={RESTRO_ID}">AGB</a></li>
                                <li class="quickad-nav-item"><a
                                        href="{LINK_DATA_PROTECTION_RESTAURANTS}?id={RESTRO_ID}">Datenschutzerklärung</a>
                                </li>
                                <li class="quickad-nav-item active"><a href="#">IMPRESSUM</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-9">
                            ...
                            <p> Unser Impressum gilt für die Seite <a href="{SITE_URL}{SLUG}">{SITE_URL}{SLUG}</a>.</p>
                            ...
                            <p>Unsere Datenschutzhinweise finden Sie unter <a
                                    href="{LINK_DATA_PROTECTION_RESTAURANTS}?id={RESTRO_ID}">{LINK_DATA_PROTECTION_RESTAURANTS}?id={RESTRO_ID}</a></p>
                            ...
                            <p>Dieses Impressum gilt auch für folgende Social Media-Profile: {SOCIAL_TEXT}</p>
