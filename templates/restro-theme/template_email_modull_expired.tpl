                    ...
                    <div class="row no-mar block-bot-space">
                        <div class="container clearfix dc">
                            ...
                            <div style="text-align: center;margin-top:20px;" class="title">
                                <h1 style="color: black;font-weight: bold;margin: 0;padding:0;letter-spacing:1px;line-height: 20px;font-size: 16px;" class="title-top-space">Ihre Vertragslaufzeit endet am <span style="color: {BACKGROUND};font-weight: bold;margin: 0;padding:0;letter-spacing:1px;line-height: 20px;font-size: 16px;">{DATE_EXPIRES}</span></h1>
                            </div>
                            <div style="background-color: #F2F2F2; padding:10px 20px;margin-top:10px;">
                               <h3 style="color: #5E5E5E;font-weight: 500;margin: 0;padding: 0;font-size: 14px;" >Bestellsnummer: <span style="font-weight: bold;color: #5E5E5E;">{ORDER_ID}</span>  <span style="font-weight: bold;float: right;color: #5E5E5E;">{ORDER_DATE}</span></h3>      
                            </div>
                            ...
                            <div style="background-color: #5E5E5E; padding:20px 20px;margin-top: 10px;">
                            ...
                            <div style="text-align: center;margin-top:20px;" class="title">
                                <h1 style="color:#FD631F;font-weight: bold;margin: 0;padding:0;letter-spacing:1px;line-height: 20px;font-size: 20px;"> Um den Vertrag zu verlängern </h1>
                                <h1 style="color: {BACKGROUND};font-weight: bold;margin: 0;padding:0;letter-spacing:1px;line-height: 20px;font-size: 18px;"> bitte hier klicken </h1>
                            </div>
