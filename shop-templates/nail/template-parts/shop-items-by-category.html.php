            ...
            <li>
                ...
                <div class="spa-price-content <?php echo $showImgClass?>">
                    <h4>
                        ...
                        <div class="prices-wrap" style="display:block;position:absolute;right:15px;top:<?php echo $data['show_image'] ? "3px;":"13px"?>">
                        <?php
                        if($data['show_price']){
                            if($data['discount']){
                ...
                <div class="item-info-in grid">
                    <ul>
                        ...
                        if($data['show_order']){?>
                        <li>
                            <a href="<?php echo $config['site_url'] . $config['shop_slug'] ?>/booking/?do=add-item&item=<?php echo $data['id']?>" data-id="<?php echo $data['id']?>" 
                                data-catid="<?php echo $data['cat_id']?>" 
                                data-duration="<?php echo $data['duration']?>"><i class="fa fa-calendar"></i>
