...
jQuery(document).on('click','.item-view-info',function(){

let ref_id = $(this).data('ref-id');
console.log(ref_id);
$('.modal_body').html($(ref_id).html());
$('#modalProductDetail').show();
  
})

jQuery(document).on('click','.modal_header',function(){
    var modal = document.getElementById("modalProductDetail");
    modal.style.display = "none";   
});


// // demo ==========
const images = document.querySelectorAll('.wrapperr .imager img')
const gallery = document.querySelector('.galleryr')
const galleryImg = document.querySelector('.gallery-inner img')
const close = document.querySelector('.galleryr .close')
...
function showGallery() {
	...
	gallery.classList.add('showr')
	galleryImg.src = images[currentIndex].src
}

close.addEventListener('click', () => {
	gallery.classList.remove('showr')
})
...
document.addEventListener('keydown', (e) => {
	if (e.keyCode == 27) gallery.classList.remove('showr')
})
// // demo========
