...
if(0 && isset($access_token)){
    ...
    if($payment_type == "subscr") {
        ...
        $cancel_url = $link['MEMBERSHIP'];//."/?access_token=".$access_token."&status=cancel";
      ...
      $slug =  $_SESSION['quickad'][$access_token]['slug'];
      $cancel_url = $link['INDEX'] . 'order/' . $slug;
...
$paypal_client_id = 'AZix0kVwE-ohJ0Fsy9cjjfX0aWtkYgl3unzKF7uVrF6N1gY8CPvr4J8JDcnbMS1XB2S81dBHyzJnrJ4i';
$paypal_secret = 'EMT4sX7JEr5W_dt9zGmhh5M9DvU2vB-UvhjfeFcfkiicpcPMlqFC-J2D3dOVLvg8Fg87VIUuMkIRK204';
...
$title  = 'Lotus Nail';
$price = 10.05;
//echo $link['PAYMENT']."/?access_token=".$access_token."&i=paypal&payment_mode=one_time";
            ...
            switch($payment_mode) {
                case 'one_time':
                    ...
                    try {
                        ...
                        payment_error("error",'001. ' . $exception->getMessage(),$access_token);
                    }
                  ...
                  ->setCancelUrl($cancel_url);
                    ...
                    try {
                        ...
                        payment_fail_save_detail($access_token);
                        //error_log($exception->getData());
                        payment_error("error",'002. ' . $exception->getMessage(),$access_token);
                    }
