            ...
            {                
                ...
                if($_GET['t'] > (time()-108000))
                {
                    ...
                    {                        
                        ...
                        {
                            $forgot_error = $lang['PLEASE_ENTER_A_PASSWORD_WITH_A_LENGTH_OF_8_20_CHARACTERS'];
                        }
...
else
{
    ...
    {
        create_user_session($loggedin['id'],$loggedin['username'],$loggedin['password'],$loggedin['user_type'],$loggedin['shop_id'], $loggedin['name']);
        update_lastactive();
