...
else
{
    ...
    header("Location:{$config['sie_url']}layout-demo/");
    //header("Location: ".$link['DASHBOARD']);
    exit;
}
...
$page->SetParameter ('OVERALL_HEADER', create_header('', '', '',false,true));
...
$page->SetParameter ('OVERALL_FOOTER', create_footer(true));
...
$page->SetParameter('ADDRESS', escape(get_option("contact_address")));
