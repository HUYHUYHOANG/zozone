...
if(isset($_POST["submit"])) {
    ...
    // }
        ...
        elseif (strlen($_POST["password"]) < 8 OR (strlen($_POST['password']) > 20)) {
            $errors++;
    ...
    if($errors == 0) {
        ...
        create_user_session($loggedin['id'],$loggedin['username'],$loggedin['password'], $loggedin['user_type'],$shop_id);
        message($lang['WELCOME'],$lang['WELCOMETOSITE'],$link['EDIT_SHOP_INFO'],false);
        exit;
    }
}
