...
if(!empty($_GET['id']))
{
 ...
 if(!empty($restaurant['id']))
 {
    ...
    $OWNER = $userdata['name'];
    $facebook_link = get_shop_option($restaurant['id'], 'shop_link_facebook');
$twitter_link = get_shop_option($restaurant['id'], 'shop_link_twitter');
$instagram_link = get_shop_option($restaurant['id'], 'shop_link_instagram');
$social_text = '';
...
if(!empty($instagram_link))
{
    ...
    $page->SetParameter ('FACEBOOK_LINK',get_shop_option($restaurant['id'], 'shop_link_facebook'));
    $page->SetParameter ('INSTAGRAM_LINK',get_shop_option($restaurant['id'], 'shop_link_instagram'));
    $page->SetParameter ('TWITTER_LINK',get_shop_option($restaurant['id'], 'shop_link_twitter'));
